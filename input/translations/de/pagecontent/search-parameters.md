...
Die Suchparameter dieses Moduls sind je Profil zusammengefasst; die 15 SearchParameter-Artefakte
selbst sind in der [Artefaktübersicht](artifacts.html) gelistet.

### Studie (ResearchStudy) — `mii-pr-studie-studie`
...
### Proband:in (ResearchSubject) — `mii-pr-studie-proband`
...
### Ein- und Ausschlusskriterium (EvidenceVariable) — `mii-pr-studie-ein-auschluss-kriterium`
...
### Studieneinschlussempfehlungen (ServiceRequest) — `mii-pr-studie-studieneinschluss-anfrage`
...
### Dokument (DocumentReference) — `mii-pr-studie-dokument`
...
### Beteiligte Person (PractitionerRole) — `mii-pr-studie-beteiligte-person`
