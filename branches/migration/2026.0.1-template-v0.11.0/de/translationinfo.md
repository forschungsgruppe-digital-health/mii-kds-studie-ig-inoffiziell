# Hinweise zur Übersetzung - MII Implementation Guide Medizinisches Forschungsvorhaben v2026.0.1
...
Übersetzte Seiten liegen unter `input/translations/de/pagecontent/` (gleicher Dateiname wie die englische Seite); Ressourcen-Übersetzungen als `.po`-Dateien unter `input/translations/de/`. Details: [`docs/recipes/add-translation.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-studie-ig-inoffiziell/blob/main/docs/recipes/add-translation.md) in diesem Repository.
