...
| Active as of 2026-08-20 | *Computable Name*:MII_PR_Studie_Dokument |
...
| DocumentReference.meta.profile | Mandatory for queries against the DIC repository, including the profile version. See[CapabilityStatement](capability-statements.md). Optional in all other cases. |
