...
```json
{
  ...
  },
  {
    ...
    "valueMarkdown" : "Provide the computable publication unit for the MII Core Dataset Medizinisches Forschungsvorhaben module, enabling implementers to discover, validate, version, and apply the specification consistently."
  },
  {
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII Implementierungsleitfaden Medizinisches Forschungsvorhaben"
      }],
  ...
  "description" : "FHIR specification of the MII Core Dataset extension module Studie (Medizinisches Forschungsvorhaben): clinical studies, study registers, study participation and eligibility criteria for the standardized secondary use of routine clinical data.",
  "jurisdiction" : [{
    "coding" : [{
