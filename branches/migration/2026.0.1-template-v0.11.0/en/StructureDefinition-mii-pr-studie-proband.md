...
| Active as of 2026-08-20 | *Computable Name*:MII_PR_Studie_Proband |
...
| ResearchSubject.meta.profile | MANDATORY for queries against the DIC repository, including the profile version. See[CapabilityStatement](capability-statements.md). Optional in all other cases. |
