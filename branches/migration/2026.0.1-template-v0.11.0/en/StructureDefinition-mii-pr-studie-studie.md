...
| Active as of 2026-08-20 | *Computable Name*:MII_PR_Studie_Studie |
...
**The differential, snapshot and further views render directly on this artifact page, below this introduction.**
...
| ResearchStudy.meta.profile | Mandatory for queries against the DIC repository, including the profile version. See[CapabilityStatement](capability-statements.md). Optional in all other cases. |
...
[mii-exa-studie-studie](ResearchStudy-mii-exa-studie-studie.md)

-------

**Search parameters**

The mandatory search parameters of this profile are described on the [Search Parameters](search-parameters.md) page.
